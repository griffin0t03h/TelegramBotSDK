...
class CurlHttpClient extends AbstractHttpClient
{
     ...
     * @return void
     */
    public function setProxy(string $proxyString = '', bool $socks5 = false): void
    {
    ...
    /**
     * @inheritDoc
     * @throws InvalidJsonException|HttpException
     */
     ...
     * @throws HttpException
     */
    private static function curlValidate(CurlHandle $curl, ?string $response = null): void
    {
